...
- [Get Application Property](#getApplicationProperty)
- [Get Advanced Settings](#getAdvancedSettings)
- [Set Application Property](#setApplicationProperty)
- [Get Global Settings](#getConfiguration)

## Get Application Property
<a name="getApplicationProperty"></a>

Official Documentation: https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-jira-settings/#api-rest-api-3-application-properties-get
...
```php
/** @var array $response */
$response = $client->getApplicationProperty(
    key: null,
...
Official Documentation: https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-jira-settings/#api-rest-api-3-application-properties-advanced-settings-get
...
```php
/** @var array $response */
$response = $client->getAdvancedSettings();
```
...
Official Documentation: https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-jira-settings/#api-rest-api-3-application-properties-id-put
...
**"Permissions" required:** *Administer Jira* "global permission".
See: https://confluence.atlassian.com/x/vYXKM
See: https://confluence.atlassian.com/x/VwCLLg
See: https://docs.oracle.com/javase/6/docs/api/index.html?java/text/SimpleDateFormat.html
See: https://docs.oracle.com/javase/6/docs/api/index.html?java/text/SimpleDateFormat.html
See: https://docs.oracle.com/javase/6/docs/api/index.html?java/text/SimpleDateFormat.html
See: https://docs.oracle.com/javase/6/docs/api/index.html?java/text/SimpleDateFormat.html
See: https://confluence.atlassian.com/x/vYXKM
...
Source: [`Jira\Client\Schema\SimpleApplicationPropertyBean`](/docs/schema/simple-application-property-bean.md)
...
Source: [`Jira\Client\Schema\ApplicationProperty`](/docs/schema/application-property.md)
...
Official Documentation: https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-jira-settings/#api-rest-api-3-configuration-get
...
See: https://confluence.atlassian.com/x/qYXKM

### Example

```php
/** @var Schema\Configuration $response */
...
Source: [`Jira\Client\Schema\Configuration`](/docs/schema/configuration.md)
...
| `timeTrackingConfiguration` | [`TimeTrackingConfiguration`](/docs/schema/time-tracking-configuration.md) | The configuration of time tracking. |
