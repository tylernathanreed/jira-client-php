...
| --- | --- | --- |
| `errors` | [`SimpleErrorCollection`](/docs/schema/simple-error-collection.md) | A collection of errors related to unchanged issues. The collection size is limited, which means not all errors may be returned. |
