# Workflow Transition Rules Update Errors

Details of any errors encountered while updating workflow transition rules.

Source: [`Jira\Client\Schema\WorkflowTransitionRulesUpdateErrors`](/src/Schema/WorkflowTransitionRulesUpdateErrors.php)

| Property | Type | Description |
| --- | --- | --- |
| `updateResults` | [`list<WorkflowTransitionRulesUpdateErrorDetails>`](/docs/schemas/workflow-transition-rules-update-error-details.md) | A list of workflows. |
