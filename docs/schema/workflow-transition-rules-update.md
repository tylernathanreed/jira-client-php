# Workflow Transition Rules Update
...
| --- | --- | --- |
| `workflows` | [`list<WorkflowTransitionRules>`](/docs/schemas/workflow-transition-rules.md) | The list of workflows with transition rules to update. |
