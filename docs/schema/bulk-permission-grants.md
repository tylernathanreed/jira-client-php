...
| `projectPermissions` | [`list<BulkProjectPermissionGrants>`](/docs/schemas/bulk-project-permission-grants.md) | List of project permissions and the projects and issues those permissions provide access to. |
