...
| `workflowsForIssueTypes` | [`list<WorkflowSchemeAssociation>`](/docs/schemas/workflow-scheme-association.md) | The new workflow to issue type mappings for this workflow scheme. |
