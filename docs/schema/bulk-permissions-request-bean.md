...
| `projectPermissions` | [`?list<BulkProjectPermissions>`](/docs/schemas/bulk-project-permissions.md) | Project permissions with associated projects and issues to look up. |
