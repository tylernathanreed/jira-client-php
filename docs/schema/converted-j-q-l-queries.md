...
| --- | --- | --- |
| `queriesWithUnknownUsers` | `?list<[JQLQueryWithUnknownUsers](/src/Schema/JQLQueryWithUnknownUsers.php)>` | List of queries containing user information that could not be mapped to an existing user |
