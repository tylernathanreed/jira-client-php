...
| `editPermissions` | `?list<[SharePermission](/src/Schema/SharePermission.php)>` | The groups and projects that can edit the filter. |
...
| `sharePermissions` | `?list<[SharePermission](/src/Schema/SharePermission.php)>` | The groups and projects that the filter is shared with. |
