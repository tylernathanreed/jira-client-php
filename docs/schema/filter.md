...
| `editPermissions` | [`?list<SharePermission>`](/docs/schemas/share-permission.md) | The groups and projects that can edit the filter. |
...
| `sharePermissions` | [`?list<SharePermission>`](/docs/schemas/share-permission.md) | The groups and projects that the filter is shared with. |
