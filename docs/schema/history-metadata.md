...
| `actor` | [`HistoryMetadataParticipant`](/docs/schema/history-metadata-participant.md) | Details of the user whose action created the history record. |
| `cause` | [`HistoryMetadataParticipant`](/docs/schema/history-metadata-participant.md) | Details of the cause that triggered the creation the history record. |
...
| `extraData` | `array<string,string>` | Additional arbitrary information about the history record. |
| `generator` | [`HistoryMetadataParticipant`](/docs/schema/history-metadata-participant.md) | Details of the system that generated the history record. |
