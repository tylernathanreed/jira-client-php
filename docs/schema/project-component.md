...
| `assigneeType` | `'PROJECT_DEFAULT'\|'COMPONENT_LEAD'\|'PROJECT_LEAD'\|'UNASSIGNED'\|null` | The nominal user type used to determine the assignee for issues created with this component. See `realAssigneeType` for details on how the type of the user, and hence the user, assigned to issues is determined. Can take the following values:
...
| Group | Operation |
| --- | --- |
| [ProjectComponents](/docs/operations/project-components.md) | [createComponent](/docs/operations/project-components.md#create-component) |
| [ProjectComponents](/docs/operations/project-components.md) | [getComponent](/docs/operations/project-components.md#get-component) |
| [ProjectComponents](/docs/operations/project-components.md) | [updateComponent](/docs/operations/project-components.md#update-component) |
| [ProjectComponents](/docs/operations/project-components.md) | [getProjectComponents](/docs/operations/project-components.md#get-project-components) |
