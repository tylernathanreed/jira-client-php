...
| --- | --- | --- |
| `jql` | [`JexpEvaluateCtxJqlIssues`](/docs/schema/jexp-evaluate-ctx-jql-issues.md) | The JQL query that specifies the set of issues available in the Jira expression. |
