...
| `custom` | [`?list<IssueContextVariable\|JsonContextVariable\|UserContextVariable>`](/src/Schema/CustomContextVariable.php) | Custom context variables and their types. These variable types are available for use in a custom context:
...
| `issues` | `JexpEvaluateCtxIssues` | The collection of issues that is available under the `issues` variable when evaluating the expression. |
