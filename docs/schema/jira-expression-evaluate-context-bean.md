...
| `custom` | `?list<IssueContextVariable\|JsonContextVariable\|UserContextVariable>` | Custom context variables and their types. These variable types are available for use in a custom context:
