...
| `notificationType` | `'CurrentAssignee'\|`<br/>`'Reporter'\|`<br/>`'CurrentUser'\|`<br/>`'ProjectLead'\|`<br/>`'ComponentLead'\|`<br/>`'User'\|`<br/>`'Group'\|`<br/>`'ProjectRole'\|`<br/>`'EmailAddress'\|`<br/>`'AllWatchers'\|`<br/>`'UserCustomField'\|`<br/>`'GroupCustomField'\|`<br/>`null` | Identifies the recipients of the notification. |
