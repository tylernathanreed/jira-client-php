...
| --- | --- | --- |
| `approvers` | [`?list<VersionApprover>`](/docs/schemas/version-approver.md) | If the expand option `approvers` is used, returns a list containing the approvers for this version. |
...
| `operations` | [`?list<SimpleLink>`](/docs/schemas/simple-link.md) | If the expand option `operations` is used, returns the list of operations available for this version. |
