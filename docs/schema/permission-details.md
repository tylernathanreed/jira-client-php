...
| --- | --- | --- |
| `editPermissions` | `list<SharePermission>` | The edit permissions for the shareable entities. |
| `sharePermissions` | `list<SharePermission>` | The share permissions for the shareable entities. |
