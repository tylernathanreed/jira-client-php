...
| --- | --- | --- |
| `contexts` | [`?list<UiModificationContextDetails>`](/src/Schema/UiModificationContextDetails.php) | List of contexts of the UI modification. The maximum number of contexts is 1000. If provided, replaces all existing contexts. |
