...
| --- | --- | --- |
| `issueTypeMappings` | `list<[IssueTypeScreenSchemeMapping](/src/Schema/IssueTypeScreenSchemeMapping.php)>` | The IDs of the screen schemes for the issue type IDs and *default*. A *default* entry is required to create an issue type screen scheme, it defines the mapping for all issue types without a screen scheme. |
