...
| --- | --- | --- |
| `customFieldReplacementList` | [`?list<CustomFieldReplacement>`](/docs/schemas/custom-field-replacement.md) | An array of custom field IDs (`customFieldId`) and version IDs (`moveTo`) to update when the fields contain the deleted version. |
