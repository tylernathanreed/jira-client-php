...
| `issues` | [`IssuesMetaBean`](/docs/schema/issues-meta-bean.md) | Contains information about the `issues` variable in the context. For example, is the issues were loaded with JQL, information about the page will be included here. |
