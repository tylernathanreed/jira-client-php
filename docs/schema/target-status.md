...
| --- | --- | --- |
| `statuses` | `array<string,list<string>>` | An object with the key as the ID of the target status and value with the list of the IDs of the current source statuses. |
