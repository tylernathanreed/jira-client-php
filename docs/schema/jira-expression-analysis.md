...
| `errors` | [`?list<JiraExpressionValidationError>`](/docs/schemas/jira-expression-validation-error.md) | A list of validation errors. Not included if the expression is valid. |
