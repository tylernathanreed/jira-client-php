...
| `errors` | `?list<[JiraExpressionValidationError](/src/Schema/JiraExpressionValidationError.php)>` | A list of validation errors. Not included if the expression is valid. |
