...
| `workflowUsages` | `?list<[WorkflowUsages](/src/Schema/WorkflowUsages.php)>` | Deprecated. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/changelog/#CHANGE-2298) for details.
