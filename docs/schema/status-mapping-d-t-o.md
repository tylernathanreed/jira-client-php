...
| `statusMigrations` | `list<[StatusMigration](/src/Schema/StatusMigration.php)>` | The list of old and new status ID mappings for the specified project and issue type. |
