...
| `property` | [`?list<JqlQueryFieldEntityProperty>`](/src/Schema/JqlQueryFieldEntityProperty.php) | When the field refers to a value in an entity property, details of the entity property value. |
