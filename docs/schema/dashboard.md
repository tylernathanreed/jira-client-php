...
| `description` | `string` |  |
| `editPermissions` | [`?list<SharePermission>`](/docs/schemas/share-permission.md) | The details of any edit share permissions for the dashboard. |
...
| `sharePermissions` | [`?list<SharePermission>`](/docs/schemas/share-permission.md) | The details of any view share permissions for the dashboard. |
