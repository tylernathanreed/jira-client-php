...
// CreatePriorityDetailsDoc
final readonly class CreatePriorityDetails extends Dto
{
    public function __construct(
         ...
         * This parameter is nullable and will become mandatory once the iconUrl parameter is deprecated.
         */
